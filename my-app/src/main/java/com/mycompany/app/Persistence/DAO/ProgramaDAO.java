...
public class ProgramaDAO {
  ...
  private static volatile ProgramaDAO instance;
   ...
   * WARNING: This keeps the initial connection for the lifecycle of the singleton.
   */
  public static ProgramaDAO getInstance(Connection connection) {
    if (instance == null) {
      synchronized (ProgramaDAO.class) {
        if (instance == null) {
          instance = new ProgramaDAO(connection);
        }
      }
    }
    return instance;
